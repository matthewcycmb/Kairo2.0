              ...
              <div className="relative">
                ...
                {showPrevChats && (
                  <>
                    ...
                    <div className="absolute left-0 top-full z-50 mt-1 w-72 overflow-hidden rounded-xl border border-white/[0.15] bg-white/[0.08] py-1 shadow-xl backdrop-blur-[40px] sm:left-auto sm:right-0">
                      {isViewingPrevious && (
                        <button
                          onClick={() => {
                            onBackToCurrent();
